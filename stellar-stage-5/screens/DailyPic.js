...
export default class DailyPicScreen extends Component {
    ...
    getAPOD = () => {
        axios
            .get("https://api.nasa.gov/planetary/apod?api_key=CtvyV6sBUIPmkC3VbPKdFPwi4EhPMdOldadM4Dfb")
            .then(response => {
        ...
        if (Object.keys(this.state.apod).length === 0) {
            ...
            return (
                ...
                <SafeAreaView style={styles.droidSafeArea}>
                  ...
                  <Text style={{color:"yellow"}}>Source  -  https://api.nasa.gov/planetary/apod?api_key=CtvyV6sBUIPmkC3VbPKdFPwi4EhPMdOldadM4Dfb</Text>
                  </ImageBackground>
                </SafeAreaView>
                </ScrollView>
                </View>
